...
export const SearchButton = ({onClick}) => {
    return (
        <button
            className="flex items-center justify-center gap-2 px-3 py-2 bg-light-600 hover:bg-light-700 hover:cursor-pointer"
            onClick={onClick}>
            <FontAwesomeIcon icon={icons.faSearch} className="text-light-50"/>
        </button>
    )
}
